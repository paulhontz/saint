...
.el-dialogform .spinner{background:url(../images/loading.gif.saint-fs) 50% 50% no-repeat;text-align:center;width:150px;height:50px;margin:10px auto;padding-top:33px;font-weight:bold}
...
.elrte-swf-placeholder{width:1px;background:url('../images/swf.png.saint-fs') 0 0 no-repeat}
.elrtetesturl{color:red;background-image:url(../images/pixel.gif.saint-fs)}
...
.el-rte .toolbar ul{position:relative;display:inline-block;display:-moz-inline-stack;display:inline-block;vertical-align:top;zoom:1;*display:inline;margin:0;list-style:none;padding:0 2px 0 5px;background:url('../images/elrte-toolbar.png.saint-fs') -934px -2px no-repeat}
.el-rte .toolbar ul.first{background:transparent;padding-left:0}
.el-rte .toolbar ul li{display:inline-block;display:-moz-inline-stack;display:inline-block;height:22px;width:22px;vertical-align:top;zoom:1;*display:inline;margin:1px 1px;padding:0;background:url('../images/elrte-toolbar.png.saint-fs') no-repeat;border:1px solid #ccc;z-index:100}
...
.elrte-logo{width:48px;height:46px;float:left;margin:.5em 1em;background:url('../images/elrte-toolbar.png.saint-fs') -880px -7px no-repeat}
